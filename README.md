...
**Reproduce figures using the published data** (requires downloading the full Zenodo archive first):

After downloading the complete data [Zenodo data archive](https://doi.org/10.5281/zenodo.19048237), run **step #3** of the workflow reported above.
